...
float RTC_DS3231::getTempAsFloat()
{
    ...
    Wire.beginTransmission(DS3231_ADDRESS);
    Wire._I2C_WRITE( DS3231_REG_TEMP_MSB );           // was just '0'
    Wire.endTransmission();

	Wire.requestFrom(DS3231_ADDRESS, 2);
    int8_t sig   = Wire._I2C_READ();                  //signed MSB
    uint8_t fract = Wire._I2C_READ() & 0b11000000;    //rest should be zeroes anyway.
